...
print('WELCOME TO PLAYLIST DOWNLOADER DEVELOPED BY')
...
print('\nCHOOSE ANY ONE - TYPE:\n')
user_res = int(input("enter : "))

print('...You choosed ' +str(user_res) + ' resolution\n.')
...
#        main_title = main_title.replace('|', '')
    ...
    if main_title not in x:
        ...
        if user_res:
            vid = yt.streams.filter(progressive=True, file_extension='mp3', res=user_res).first()
            print('Downloading. . . ' + ' and its file size -> ' + str(round(vid.filesize / (1024 * 1024), 2)) + ' MB.')
